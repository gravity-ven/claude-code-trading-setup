...
def get_stock_data(symbol):
    """
    Get detailed stock data for breakthrough insights analysis
    Returns OHLCV data for the requested period
    """
    try:
        ...
        logger.info(f"Successfully fetched {len(prices)} data points for {symbol} ({company_name})")
